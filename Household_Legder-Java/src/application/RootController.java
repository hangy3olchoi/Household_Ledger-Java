...
public class RootController implements Initializable {
	...
	private HomeBook getVo() {
		...
		if (radioRevenue.isSelected()) {
			vo.setSection("Revenue");
		} else {
			vo.setSection("Expense");
		}
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		comboAccounttitle.getItems().addAll("수입_급여", "수입_상여", "수입_투자 수입", "수입_기타 수입", "지출_의류 및 잡화", "지출_식대", 
				"지출_식료품", "지출_간식", "지출_외식", "지출_주택관리비", "지출_공과금", "지출_소모품", "지출_건강 관련",
				"지출_보험 관련", "지출_운동 관련","지출_기타 비용");
